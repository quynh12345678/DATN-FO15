...
const ProductDescriptionTab = (props) => {
  ...
  const submitForm = async (e) => {
    try {
      ...
      } else message.error("Đánh giá sản phẩm không thành công!");
            ...
            <Nav variant="pills" className="description-review-topbar">
              ...
              <Nav.Item>
                <Nav.Link eventKey="productReviews">
                  Đánh giá{" "}
                  {props?.paging?.total ? `(${props?.paging?.total})` : ""}
                </Nav.Link>
              </Nav.Item>
            </Nav>
                                ...
                                <div className="review-top-wrap">
                                  <div className="review-left d-block">
                                    ...
                                    <div className="review-rating mt-2">
                                      <StarIcons
                                        rating_number={item?.r_number}
                                      />
                                    </div>
                                  </div>
                                </div>
                                <div className="review-bottom">
                                  <p className="w-100">{item?.r_content}</p>
                                </div>
                              </div>
                            </div>
                          );
                  ...
                  {getItem("access_token") && (
                    <div className="col-lg-5">
                      <div className="ratting-form-wrapper pl-50">
                            ...
                            <div className="ratting-form">
                              ...
                              >
                                ...
                                <div className="mb-3">
                                  ...
                                  >
                                    <TextArea
                                      className="mb-0 rating-form-style"
                                      rows={5}
                                      maxLength={300}
                        ...
                        {props?.productFullDesc?.rating > 0 && (
                          <>
                            <div className="ratting-form">
