...
const Checkout = ({ location, cartItems, currency, dispatch }) => {
  ...
  let voucherHeader = new URLSearchParams(window.location.search).get(
    "voucher"
  );
  ...
  const setPrice = (amount, maximum) => {
    var price = cartTotalPrice;
    if (amount) {
      price = (price * (100 - amount)) / 100;
    }
    if (price < cartTotalPrice - maximum) {
      setAmountVoucher(maximum + "vnd");
      setTotal(cartTotalPrice - maximum);
    } else {
                      ...
                      <div className="your-order-product-info">
                              ...
                              return (
                                <li key={key}>
                                  <span className="order-middle-left">
                                    ...
                                    <br />
                                    <p>
                                      Màu: {cartItem.selectedProductColor}
                                      <br />
                          ...
                          <>
                            <div className="your-order-bottom">
                              <ul>
                                ...
                                <li style={{ color: "red" }}>
                                  -
                                  {parseInt(amountVoucher).toLocaleString(
                                    "vi-VN"
                                  )}{" "}
                                  VNĐ
                                </li>
                        ...
                        <div className="your-order-total">
                          <ul>
                            ...
                            <li>{customNumber(total.toFixed(0), "₫")}</li>
                          </ul>
                        </div>
                      </div>
